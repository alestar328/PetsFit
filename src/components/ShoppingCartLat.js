...
function ShoppingCartLat({ isOpen, onClose, cartItems, updateQuantity, removeItem, clearCart }) {
    // Calcular el total del carrito
    const calculateTotal = () => {
        return cartItems.reduce((total, item) => {
            return total + (parseFloat(item.currentPrice) * item.quantity);
        }, 0).toFixed(2);
    };
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="font-bold text-[#4a3728]">
                                                    S/ {(parseFloat(item.currentPrice) * item.quantity).toFixed(2)}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
