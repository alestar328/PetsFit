    ...
    const menuItems = [
        {
            id: 1,
            title: "Menú de Pollo",
            image: cat1, // Reemplaza con tu imagen real
            alt: "Perro beagle comiendo menú de pollo"
        },
        {
            id: 2,
            title: "Menú de Salmón",
            image: dog, // Reemplaza con tu imagen real
            alt: "Gato comiendo menú de salmón"
        },
        {
            id: 3,
            title: "Menú de Pavo",
            image: cat2, // Reemplaza con tu imagen real
            alt: "Gato naranja comiendo menú de pavo"
        },
        {
            id: 4,
            title: "Menú de Buey",
            image: dog2, // Reemplaza con tu imagen real
